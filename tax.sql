...
--
-- Dumping data for table `wht_type`
--

LOCK TABLES `wht_type` WRITE;
/*!40000 ALTER TABLE `wht_type` DISABLE KEYS */;
INSERT INTO `wht_type` VALUES ('C1','Customer Wht Type - Pasal 23',NULL,NULL),('V1','Vendor Wht Type - Pasal 4(2)',NULL,NULL),('V2','Vendor Wht Type - Pasal 21 Non Karyawan',NULL,NULL),('V3','Vendor Wht Type - Pasal 23',NULL,NULL),('V4','Vendor Wht Type - Pasal 26',NULL,NULL);
/*!40000 ALTER TABLE `wht_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `wht_code`
--

DROP TABLE IF EXISTS `wht_code`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wht_code` (

<template>
    <div>
        <el-form :inline="true" style="text-align:right" @submit.native.prevent="() => { return }">
            <el-form-item>
                <el-button icon="el-icon-plus" @click="openForm({role: 0, password: ''})" type="primary">ADD NEW PARTNERSHIP TYPE</el-button>
            </el-form-item>
        ...
        <el-dialog :visible.sync="showForm" :title="!!formModel.id ? 'EDIT PARTNERSHIP TYPE' : 'ADD NEW PARTNERSHIP TYPE'" width="500px" v-loading="loading" :close-on-click-modal="false">

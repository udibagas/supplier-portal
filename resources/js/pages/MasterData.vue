<template>
    <div>
        <el-page-header @back="$emit('goBack')" content="MASTER DATA">
        </el-page-header>
        <el-divider></el-divider>
        <el-tabs type="card">
            <el-tab-pane lazy label="Account Group"><AccountGroup /></el-tab-pane>
            <el-tab-pane lazy label="Bank"><Bank /></el-tab-pane>

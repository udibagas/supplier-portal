<template>
    <div>
        <el-form :inline="true" style="text-align:right" @submit.native.prevent="() => { return }">
            <el-form-item>
                <el-button icon="el-icon-plus" @click="openForm({role: 0, password: ''})" type="primary">ADD NEW BANK</el-button>
            </el-form-item>
        ...
        <el-dialog :visible.sync="showForm" :title="!!formModel.id ? 'EDIT BANK' : 'ADD NEW BANK'" width="500px" v-loading="loading" :close-on-click-modal="false">
...
export default {
    ...
    methods: {
        ...
        store() {
            this.loading = true;
            axios.post('/bank', this.formModel).then(r => {
                this.showForm = false;
                this.$message({
        ...
        update() {
            this.loading = true;
            axios.put('/bank/' + this.formModel.id, this.formModel).then(r => {
                this.showForm = false
                this.$message({
                    message: 'Data berhasil disimpan.',
                    type: 'success',
        ...
        requestData() {
            ...
            this.loading = true;
            axios.get('/bank', {params: params}).then(r => {
